...
This directory contains the research modules maintained in this repository.
...
Frozen offline inputs and reproduction guide:
[`modules/Skyrescue/release/jss-submission-v1.0`](./Skyrescue/release/jss-submission-v1.0).
See [`modules/Skyrescue/README.md`](./Skyrescue/README.md) for install and run instructions.

## Notes

- `Skyrescue/` is the paper-focused module for SkyRescue. Its compact,
  de-identified frozen input bundle is under `release/jss-submission-v1.0/`;
  large generated telemetry remains outside Git.
- This repository currently publishes the SkyRescue module only.
  Additional modules may be added later without changing the existing layout.
