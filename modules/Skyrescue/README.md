...
The implementation corresponding to the manuscript evidence is maintained in this
directory. The frozen offline bundle is
[`release/jss-submission-v1.0`](./release/jss-submission-v1.0).
